...
namespace AutoCSer.TestCase.TcpInternalServerPerformance
{
    ...
    public partial class InternalServer
    {
        ...
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ServerTask = AutoCSer.Net.TcpServer.ServerTaskType.Synchronous, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ServerTask = AutoCSer.Net.TcpServer.ServerTaskType.TcpQueue, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ServerTask = AutoCSer.Net.TcpServer.ServerTaskType.TcpTask, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ServerTask = AutoCSer.Net.TcpServer.ServerTaskType.Timeout, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        [AutoCSer.Net.TcpServer.Method(ParameterFlags = AutoCSer.Net.TcpServer.ParameterFlags.OutputSerializeBox, ServerTask = AutoCSer.Net.TcpServer.ServerTaskType.ThreadPool, ClientTask = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsClientAsynchronous = true, IsClientSynchronous = false)]
        [MethodImpl(AutoCSer.MethodImpl.AggressiveInlining)]
