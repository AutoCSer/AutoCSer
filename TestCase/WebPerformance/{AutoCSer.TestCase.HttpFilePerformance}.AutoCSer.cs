...
namespace AutoCSer.TestCase.HttpFilePerformance
{
        ...
        public partial class WebServer : AutoCSer.Net.HttpDomainServer.ViewServer<int>
        {
            ...
            private static readonly AutoCSer.WebView.CallMethodInfo _i0 = new AutoCSer.WebView.CallMethodInfo { MethodIndex = 0, MaxMemoryStreamSize = (AutoCSer.SubBuffer.Size)65536, MaxPostDataSize = 4194304, IsOnlyPost = false };
