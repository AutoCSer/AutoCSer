...
namespace AutoCSer.TestCase.Nuget
{
        internal partial class Server
        {
            ...
            /// <summary>
            /// AutoCSer.TestCase.Nuget.Server TCP服务
            /// </summary>
            public sealed class TcpInternalServer : AutoCSer.Net.TcpInternalServer.Server
            {
                public readonly AutoCSer.TestCase.Nuget.Server Value;
                /// <summary>
                ...
                public TcpInternalServer(AutoCSer.Net.TcpInternalServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
                    : base(attribute ?? (attribute = AutoCSer.Net.TcpInternalServer.ServerAttribute.GetConfig("AutoCSer.TestCase.Nuget.Server", typeof(AutoCSer.TestCase.Nuget.Server))), verify, null, onCustomData, log, 0, false, false)
                {
                ...
                sealed class _s0 : AutoCSer.Net.TcpInternalServer.ServerCall<_s0, AutoCSer.TestCase.Nuget.Server, _p1>
                {
