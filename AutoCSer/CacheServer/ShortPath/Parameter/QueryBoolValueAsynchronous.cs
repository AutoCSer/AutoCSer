...
namespace AutoCSer.CacheServer.ShortPath.Parameter
{
    ...
    public partial struct QueryBoolValueAsynchronous
    {
        ...
        internal QueryBoolValueAsynchronous(Node node)
        {
            this.node = node;
        }
        /// <summary>
        ...
        {
            return Client.GetBool(node.ShortPath.Client.OperationAsynchronous(node));
        }
        /// <summary>
        /// 查询数据
        /// </summary>
        ...
        public void Query(Action<ReturnValue<bool>> onGet)
        {
            ...
            node.ShortPath.Client.OperationAsynchronousNotNull(node, onGet);
        }
        /// <summary>
        /// 查询数据
        /// </summary>
        ...
        {
            if (onGet == null) throw new ArgumentNullException();
            node.ShortPath.Client.OperationAsynchronousStream(node, onGet);
        }
        /// <summary>
        /// 查询数据
        /// </summary>
