...
namespace AutoCSer.CacheServer.MessageQueue.Abstract
{
    ...
    /// 消息队列 客户端消费者 处理器
    /// </summary>
    internal abstract class QueueConsumerProcessor : QueueConsumerStreamProcessor
    {
        /// <summary>
        /// 处理消息
        /// </summary>
        ...
        internal QueueConsumerProcessor(QueueConsumer consumer) : base(consumer) { }
    }
    /// <summary>
    /// 消息队列 客户端消费者 处理器
    /// </summary>
    /// <typeparam name="valueType">数据类型</typeparam>
    internal abstract class QueueConsumerProcessor<valueType> : QueueConsumerProcessor
    {
        /// <summary>
        /// 消息集合
        /// </summary>
        ...
        /// </summary>
        /// <param name="consumer">消息队列 客户端消费者</param>
        protected QueueConsumerProcessor(QueueConsumer consumer) : base(consumer)
        {
        ...
        protected QueueConsumerProcessor(QueueConsumer consumer, ValueData.GetData<valueType> getValue, ValueData.DataType dataType) : base(consumer)
        {
        ...
        private void onGetDequeueIdentity(AutoCSer.Net.TcpServer.ReturnValue<ReturnParameter> identity)
        {
            ...
            finally
            {
                ...
                {
                    messages = null;
                    AutoCSer.Threading.TimerTask.Default.Add(Start, Date.NowTime.Now.AddTicks(Date.SecondTicks));
                }
            }
        }
        /// <summary>
        ...
        {
            return message.Type == ReturnType.Success && onGetMessage(ref message.Parameter);
        }
        /// <summary>
        /// 读取数据
        /// </summary>
