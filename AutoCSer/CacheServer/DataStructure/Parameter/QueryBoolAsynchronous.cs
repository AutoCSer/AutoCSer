...
namespace AutoCSer.CacheServer.DataStructure.Parameter
{
    ...
    public sealed partial class QueryBoolAsynchronous : Node
    {
        ...
        internal QueryBoolAsynchronous(Abstract.Node parent, OperationParameter.OperationType operationType) : base(parent, operationType) { }
        /// <summary>
        /// 查询数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            return Client.GetBool(Parent.ClientDataStructure.Client.QueryAsynchronous(this));
        }
        /// <summary>
        /// 查询数据
        /// </summary>
