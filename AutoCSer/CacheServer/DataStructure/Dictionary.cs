...
#else
            constructor = (Func<Abstract.Node, Dictionary<keyType, nodeType>>)AutoCSer.Emit.Constructor.CreateDataStructure(typeof(Dictionary<keyType, nodeType>), NodeConstructorParameterTypes);
#endif
        }
    }
}
