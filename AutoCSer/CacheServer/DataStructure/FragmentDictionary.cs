...
#else
            constructor = (Func<Abstract.Node, FragmentDictionary<keyType, nodeType>>)AutoCSer.Emit.Constructor.Create(typeof(FragmentDictionary<keyType, nodeType>), NodeConstructorParameterTypes);
#endif
        }
    }
}
