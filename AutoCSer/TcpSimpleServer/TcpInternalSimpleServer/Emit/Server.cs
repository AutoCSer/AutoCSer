...
namespace AutoCSer.Net.TcpInternalSimpleServer.Emit
{
    ...
    public static class Server<interfaceType>
    {
        ...
        public static TcpInternalSimpleServer.Server Create(interfaceType value, ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null, AutoCSer.ILog log = null)
        {
            ...
            TcpSimpleServer.ISetTcpServer<TcpInternalSimpleServer.Server> setTcpServer = value as TcpSimpleServer.ISetTcpServer<TcpInternalSimpleServer.Server>;
