...
namespace AutoCSer.Net.TcpStreamServer
{
    ...
    public abstract class ServerSocket<serverType, socketType, socketSenderType> : TcpServer.ServerSocket
        ...
        where socketSenderType : ServerSocketSender<serverType, socketType, socketSenderType>
    {
        ...
        internal ServerSocket(serverType server)
            : base(server.BinaryDeSerializeConfig, server.CallQueueArray, server.CallQueue, server.CallQueueLink, AutoCSer.Net.TcpServer.Server.DefaultVerifyMethodCount)
        {
            Server = server;
        }
        /// <summary>
