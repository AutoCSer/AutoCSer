...
namespace AutoCSer.Net.TcpOpenStreamServer.Emit
{
    ...
    internal abstract partial class ParameterGenericType : AutoCSer.Net.TcpServer.Emit.ParameterGenericType
    {
        ...
        /// TCP 开放服务客户端
        /// </summary>
        internal static readonly TcpOpenStreamServer.Client Client = new Client();
        /// <summary>
        /// TCP 开放服务客户端套接字数据发送
        /// </summary>
        ...
        where parameterType : struct
    {
        ...
        {
            get { return ((AutoCSer.Net.TcpInternalStreamServer.Emit.ParameterGenericType<parameterType>.ServerSocketSenderPushCommand)ServerSocketSender.Push<parameterType>).Method; }
        }
    }
}
