...
namespace AutoCSer.Net.TcpOpenStreamServer
{
    ...
    public static class TimeVerifyClient
    {
        ...
        /// <returns></returns>
        public unsafe static bool Verify(Verifier verify, ClientSocketSender sender, AutoCSer.Net.TcpOpenStreamServer.Client client, string userID, string verifyString)
        {
            long ticks;
            ulong markData = 0;
