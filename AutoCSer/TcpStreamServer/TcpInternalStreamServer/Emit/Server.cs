...
namespace AutoCSer.Net.TcpInternalStreamServer.Emit
{
    ...
    internal static class Server
    {
        ...
        /// TCP 服务端元数据
        /// </summary>
        internal static readonly ServerMetadata Metadata = new ServerMetadata(typeof(TcpInternalStreamServer.Server), typeof(ServerAttribute), typeof(ServerSocketSender), typeof(ServerCall)
    ...
    public static class Server<interfaceType>
    {
        ...
        /// TCP 函数集合
        /// </summary>
        private static readonly Method<ServerAttribute, TcpStreamServer.MethodAttribute, ServerSocketSender>[] methods;
        /// <summary>
        /// TCP 服务类型
        /// </summary>
        ...
        public static TcpInternalStreamServer.Server Create(interfaceType value, TcpInternalStreamServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null, AutoCSer.Log.ILog log = null)
        {
            ...
            TcpInternalStreamServer.Server server = (TcpInternalStreamServer.Server)serverConstructorInfo.Invoke(new object[] { attribute = attribute ?? defaultServerAttribute, verify, value, log });
            server.setCommandData(methods.Length);
            foreach (Method<ServerAttribute, TcpStreamServer.MethodAttribute, ServerSocketSender> method in methods)
            {
                if (method != null)
                {
        ...
        static Server()
        {
            ...
            if (isMethod)
            {
                ...
                Method<ServerAttribute, TcpStreamServer.MethodAttribute, ServerSocketSender>.ServerBuilder serverBuilder = new Method<ServerAttribute, TcpStreamServer.MethodAttribute, ServerSocketSender>.ServerBuilder { Metadata = Server.Metadata };
