...
namespace AutoCSer.Net.TcpServer.Emit
{
    ...
    internal abstract class ServerMetadataBase
    {
        ...
        internal ServerMetadataBase(Type serverType, Type serverAttributeType, Type senderType, Type serverCallType)
        {
    ...
    internal sealed class ServerMetadata : ServerMetadataBase
    {
        ...
        /// <param name="senderType">TCP 服务套接字发送数据类型</param>
        /// <param name="serverCallType">TCP 服务器端同步调用类型</param>
        internal ServerMetadata(Type serverType, Type serverAttributeType, Type senderType, Type serverCallType) : base(serverType, serverAttributeType, senderType, serverCallType)
        {
