...
namespace AutoCSer.Net.TcpOpenServer.Emit
{
    ...
    public static class Server<interfaceType>
    {
        ...
        public static TcpOpenServer.Server Create(interfaceType value, TcpOpenServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
        {
            ...
            TcpOpenServer.Server server = (TcpOpenServer.Server)serverConstructorInfo.Invoke(new object[] { attribute = attribute ?? defaultServerAttribute, verify, value, onCustomData, log });
            ...
            TcpServer.ISetTcpServer<TcpOpenServer.Server, ServerAttribute> setTcpServer = value as TcpServer.ISetTcpServer<TcpOpenServer.Server, ServerAttribute>;
