...
namespace AutoCSer.Extensions
{
    ...
    public static class SynchronizationContext
    {
        ...
        {
            new AutoCSer.Threading.SynchronizationContextPost(context).Post(action, value);
        }
        /// <summary>
        /// UI 线程上下文 POST 调用
        /// </summary>
        ...
        {
            new AutoCSer.Threading.SynchronizationContextPost(context).Post(action);
        }
        /// <summary>
        ...
        {
            return new AutoCSer.Threading.SynchronizationContextPost(context).GetPost(action);
        }
        /// <summary>
        /// 获取 UI 线程上下文 POST 调用委托
        /// </summary>
