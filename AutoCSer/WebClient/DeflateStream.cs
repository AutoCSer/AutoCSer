...
namespace AutoCSer.Net.WebClient
{
    ...
    /// deflate压缩流处理
    /// </summary>
    internal class DeflateStream : CompressionStream
    {
        /// <summary>
        /// 获取压缩流
        /// </summary>
        ...
        {
            return new System.IO.Compression.DeflateStream(dataStream, CompressionMode.Compress, true);
        }
        /// <summary>
        /// 获取解压缩流
        /// </summary>
        ...
        {
            return new System.IO.Compression.DeflateStream(dataStream, CompressionMode.Decompress, false);
        }
    }
}
