...
namespace AutoCSer.Extensions
{
    ...
    public static partial class LeftArrayExtensionSort
    {
        ...
        {
            return ArrayExtensionSort.RangeSort(values.Array, 0, values.Length, comparer, skipCount, getCount);
        }
        /// <summary>
        /// 范围排序
        /// </summary>
        ...
        public static SubArray<valueType> GetRangeSort<valueType>
            (this LeftArray<valueType> values, Func<valueType, valueType, int> comparer, int skipCount, int getCount)
        {
            return ArrayExtensionSort.GetRangeSort(values.Array, 0, values.Length, comparer, skipCount, getCount);
        }
    }
}
