...
namespace AutoCSer.Json
{
    ...
    internal struct DeSerializeDynamicMethod
    {
        ...
        public DeSerializeDynamicMethod(Type type, bool isMemberMap)
        {
            dynamicMethod = new DynamicMethod((this.isMemberMap = isMemberMap) ? "JsonMemberMapDeSerializer" : "JsonDeSerializer", typeof(int), isMemberMap ? new Type[] { typeof(JsonDeSerializer), type.MakeByRefType(), typeof(byte*), typeof(MemberMap) } : new Type[] { typeof(JsonDeSerializer), type.MakeByRefType(), typeof(byte*) }, type, true);
        ...
        {
            #region if ((names = deSerializer.IsName(names, ref index)) != null)
            generator.Emit(OpCodes.Ldarg_0);
            generator.Emit(OpCodes.Ldarg_2);
            generator.Emit(OpCodes.Ldloca_S, indexLocalBuilder);
            generator.call((((JsonDeSerializer.IsNameDelegate)JsonDeSerializer.IsName)).Method);
        ...
        {
            #region if (deSerializer.State == DeSerializeState.Success)
            generator.Emit(OpCodes.Ldarg_0);
            generator.call(((Func<JsonDeSerializer, DeSerializeState>)JsonDeSerializer.GetState).Method);
