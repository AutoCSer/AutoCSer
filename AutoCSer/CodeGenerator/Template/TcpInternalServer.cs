...
#region IF Type.Type.IsPublic
                ...
                public TcpInternalServer(AutoCSer.Net.TcpInternalServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null/*IF:Type.Type.IsPublic*/, @Type.FullName value = null/*IF:Type.Type.IsPublic*/, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
                    : base(attribute ?? (attribute = AutoCSer.Net.TcpInternalServer.ServerAttribute.GetConfig("@ServerRegisterName", typeof(@Type.FullName))), verify, onCustomData, log)
                {
            ...
            public class TcpInternalClient : AutoCSer.Net.TcpInternalServer.MethodClient<TcpInternalClient>
            {
                ...
                #region NOTE
                public AutoCSer.Net.TcpServer.ReturnValue<bool> verify(AutoCSer.Net.TcpInternalServer.ClientSocketSender sender, ulong randomPrefix, byte[] md5Data, ref long ticks) { return false; }
                #endregion NOTE
                ...
                /// <param name="onCustomData">自定义数据包处理</param>
                /// <param name="log">日志接口</param>
                public TcpInternalClient(AutoCSer.Net.TcpInternalServer.ServerAttribute attribute = null/*IF:IsVerifyMethod*/, Func<TcpInternalClient, AutoCSer.Net.TcpInternalServer.ClientSocketSender, bool> verifyMethod = null/*IF:IsVerifyMethod*/, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
                {
                    if (attribute == null)
                    {
                        #region IF IsServerCode
                        ...
                        attribute = AutoCSer.Config.Loader.Get<AutoCSer.Net.TcpInternalServer.ServerAttribute>("@ServerRegisterName") ?? AutoCSer.Json.Parser.Parse<AutoCSer.Net.TcpInternalServer.ServerAttribute>(@"@AttributeJson");
                        if (attribute.Name == null) attribute.Name = "@ServerRegisterName";
                        #endregion NOT IsServerCode
                    }
                    _TcpClient_ = new AutoCSer.Net.TcpInternalServer.Client<TcpInternalClient>(this, attribute, onCustomData, log/*IF:IsVerifyMethod*/, verifyMethod/*IF:IsTimeVerify*/ ?? (Func<TcpInternalClient, AutoCSer.Net.TcpInternalServer.ClientSocketSender, bool>)_timerVerify_/*IF:IsTimeVerify*//*IF:IsVerifyMethod*/);
                ...
                public AutoCSer.Net.TcpServer.ReturnValue/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/ /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*IF:IsVerifyMethod*/AutoCSer.Net.TcpInternalServer.ClientSocketSender _sender_, /*IF:IsVerifyMethod*//*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    ...
                    #endregion IF Attribute.IsExpired
                    #region NOT Attribute.IsExpired
                    AutoCSer.Net.TcpServer.AutoWaitReturnValue/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _wait_ = _TcpClient_.GetAutoWait/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/();
                    if (_wait_ != null)
                    {
                        int _isWait_ = 0;
                        try
                        {
                            ...
                            if (_socket_ != null)
                            {
                                ...
                                _socket_.Get</*IF:InputParameterIndex*/TcpInternalServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalServer.@OutputParameterTypeName>(@MethodIdentityCommand, _wait_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/, ref _outputParameter_);
                                _isWait_ = 1;
                                AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _returnOutputParameter_;
                        ...
                        {
                            if (_isWait_ == 0) AutoCSer.Net.TcpServer.AutoWaitReturnValue/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/.PushNotNull(_wait_);
                        }
                    }
                    #region LOOP InputParameters
                    #region PUSH MethodParameter
                    ...
                    if (_onReturn_ == null || _onOutput_ != null)
                    {
                        ...
                        try
                        {
                            ...
                            if (_socket_ != null)
                            {
                                ...
                                #endregion IF InputParameterIndex
                                #region IF IsKeepCallback
                                AutoCSer.Net.TcpServer.KeepCallback _keepCallback_ = _socket_.Get</*IF:InputParameterIndex*/TcpInternalServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalServer.@OutputParameterTypeName>(@MethodAsynchronousIdentityCommand, _onOutput_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/);
                                _isWait_ = 1;
                                return /*NOTE*/(KeepCallbackType)(object)/*NOTE*/_keepCallback_;
                                #endregion IF IsKeepCallback
                                #region NOT IsKeepCallback
                                _socket_.Get</*IF:InputParameterIndex*/TcpInternalServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalServer.@OutputParameterTypeName>(@MethodAsynchronousIdentityCommand, _onOutput_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/);
                                _isWait_ = 1;
                        ...
                        if (_wait_ != null)
                        {
                            ...
                            try
                            {
                                ...
                                if (_socket_ != null)
                                {
                                    ...
                                    #endregion IF InputParameterIndex
                                    _socket_.Get</*IF:InputParameterIndex*/TcpInternalServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalServer.@OutputParameterTypeName>(@MethodIdentityCommand, _wait_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/);
                                    _isWait_ = 1;
                                    AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _outputParameter_ = new AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/();
    ...
    internal partial class Pub
    {
        ...
        /// 类型全名
        /// </summary>
        public partial class FullName : AutoCSer.Net.TcpServer.ISetTcpServer<AutoCSer.Net.TcpInternalServer.Server, AutoCSer.Net.TcpInternalServer.ServerAttribute>
        {
            /// <summary>
            /// 设置TCP服务端
            /// </summary>
