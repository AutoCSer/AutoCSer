...
{
    class TcpInternalStreamServer : Pub
    {
        #region PART CLASS
        /*NOTE*/
        ...
        #endregion IF IsSetTcpServer
        {
            ...
            public void SetTcpServer(AutoCSer.Net.TcpInternalStreamServer.Server commandServer) { }
            #endregion NOTE
            #region IF IsServerCode
            ...
            /// </summary>
            public sealed class TcpInternalStreamServer/*IF:IsServerCode*/ : AutoCSer.Net.TcpInternalStreamServer.Server/*IF:IsServerCode*/
            {
                #region IF IsServerCode
...
#region IF Type.Type.IsPublic
                ...
                public TcpInternalStreamServer(AutoCSer.Net.TcpInternalStreamServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null/*IF:Type.Type.IsPublic*/, @Type.FullName value = null/*IF:Type.Type.IsPublic*/, AutoCSer.Log.ILog log = null)
                    : base(attribute ?? (attribute = AutoCSer.Net.TcpInternalStreamServer.ServerAttribute.GetConfig("@ServerRegisterName", typeof(@Type.FullName))), verify, log)
                {
                ...
                #region NOT IsNullMethod
                #region IF IsMethodServerCall
                sealed class @MethodStreamName : AutoCSer.Net.TcpInternalStreamServer.ServerCall<@MethodStreamName, @Type.FullName/*IF:InputParameterIndex*/, @InputParameterTypeName/*IF:InputParameterIndex*/>
                {
            ...
            public partial class TcpInternalStreamClient : AutoCSer.Net.TcpInternalStreamServer.MethodClient<TcpInternalStreamClient>
            {
                ...
                {
                    return AutoCSer.Net.TcpInternalStreamServer.TimeVerifyClient.Verify(verify, sender, _TcpClient_);
                }
                #region NOTE
                public AutoCSer.Net.TcpServer.ReturnValue<bool> verify(AutoCSer.Net.TcpInternalStreamServer.ClientSocketSender sender, string userID, ulong randomPrefix, byte[] md5Data, ref long ticks) { return false; }
                #endregion NOTE
                ...
                void /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    ...
                    #region NOT Attribute.IsExpired
                    #region IF InputParameterIndex
                    TcpInternalStreamServer.@InputParameterTypeName _inputParameter_ = new TcpInternalStreamServer.@InputParameterTypeName
                    {
                        #region LOOP InputParameters
                        /*PUSH:Parameter*/
                ...
                AutoCSer.Net.TcpServer.ReturnValue/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/ /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*IF:IsVerifyMethod*/AutoCSer.Net.TcpInternalStreamServer.ClientSocketSender _sender_, /*IF:IsVerifyMethod*//*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    ...
                    #endregion IF Attribute.IsExpired
                    #region NOT Attribute.IsExpired
                    AutoCSer.Net.TcpServer.AutoWaitReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _wait_ = AutoCSer.Net.TcpServer.AutoWaitReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/.Pop();
                    try
                    {
                        AutoCSer.Net.TcpInternalStreamServer.ClientSocketSender _socket_ = /*NOT:IsVerifyMethod*/_TcpClient_.Sender/*NOT:IsVerifyMethod*//*NOTE*/ ?? /*NOTE*//*IF:IsVerifyMethod*/_sender_/*IF:IsVerifyMethod*/;
                        if (_socket_ != null)
                        {
                            #region IF InputParameterIndex
                            TcpInternalStreamServer.@InputParameterTypeName _inputParameter_ = new TcpInternalStreamServer.@InputParameterTypeName
                            ...
                            #endregion IF InputParameterIndex
                            #region IF OutputParameterIndex
                            TcpInternalStreamServer.@OutputParameterTypeName _outputParameter_ = new TcpInternalStreamServer.@OutputParameterTypeName
                            {
                                #region LOOP OutputParameters
                            ...
                            AutoCSer.Net.TcpServer.ReturnType _returnType_ = _socket_.WaitGet</*IF:InputParameterIndex*/TcpInternalStreamServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalStreamServer.@OutputParameterTypeName>(@MethodIdentityCommand, ref _wait_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/, ref _outputParameter_);
                            #region LOOP OutputParameters
                    ...
                    {
                        if (_wait_ != null) AutoCSer.Net.TcpServer.AutoWaitReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/.PushNotNull(_wait_);
                    }
                    #region LOOP InputParameters
                    #region PUSH MethodParameter
                    #region IF IsOut
                ...
                AutoCSer.Net.TcpServer.@Awaiter/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/ /*PUSH:Method*/@AwaiterMethodName/*PUSH:Method*/(/*IF:IsVerifyMethod*/AutoCSer.Net.TcpInternalStreamServer.ClientSocketSender _sender_, /*IF:IsVerifyMethod*//*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    ...
                    if (_socket_ != null)
                    {
                        ...
                        _returnType_ = _socket_.GetAwaiter</*IF:InputParameterIndex*/TcpInternalStreamServer.@InputParameterTypeName, /*IF:InputParameterIndex*/AutoCSer.Net.TcpServer.@AwaiterReturnValue<@MethodReturnType.FullName>>(@AwaiterMethodIdentityCommand, _awaiter_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/, ref _outputParameter_);
                        #endregion IF MethodIsReturn
                ...
                async System.Threading.Tasks.Task<AutoCSer.Net.TcpServer.ReturnValue/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/> /*PUSH:Method*/@TaskAsyncMethodName/*PUSH:Method*/(/*IF:IsVerifyMethod*/AutoCSer.Net.TcpInternalStreamServer.ClientSocketSender _sender_, /*IF:IsVerifyMethod*//*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    ...
                    if (_socket_ != null)
                    {
                        AutoCSer.Net.TcpServer.TaskAsyncReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _wait_ = new AutoCSer.Net.TcpServer.TaskAsyncReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/();
                        #region IF InputParameterIndex
                        TcpInternalStreamServer.@InputParameterTypeName _inputParameter_ = new TcpInternalStreamServer.@InputParameterTypeName
                        {
                            #region LOOP InputParameters
                        ...
                        if ((_returnType_ = _socket_.GetAsync</*IF:InputParameterIndex*/TcpInternalStreamServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalStreamServer.@OutputParameterTypeName>(@AwaiterMethodIdentityCommand, _wait_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/, ref _outputParameter_)) == AutoCSer.Net.TcpServer.ReturnType.Success)
                        {
                            AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _returnOutputParameter_ = await _wait_;
                            #region LOOP OutputParameters
                            #region IF InputMethodParameter.IsRefOrOut
                            /*PUSH:MethodParameter*/
                ...
                #region IF MethodIsReturn
                /*AT:IsInternalClient*/
                void /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterName, /*PUSH:MethodParameter*//*LOOP:InputParameters*/Action<AutoCSer.Net.TcpServer.ReturnValue/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/> _onReturn_)
                {
                    #region IF Attribute.IsExpired
                    ...
                    #endregion IF Attribute.IsExpired
                    #region NOT Attribute.IsExpired
                    AutoCSer.Net.Callback<AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/> _onOutput_ = _TcpClient_.GetCallback</*IF:MethodIsReturn*/@MethodReturnType.FullName, /*IF:MethodIsReturn*/TcpInternalStreamServer.@OutputParameterTypeName>(_onReturn_);
                    try
                    {
                        ...
                        if (_socket_ != null)
                        {
                            ...
                            #endregion IF InputParameterIndex
                            _socket_.Get</*IF:InputParameterIndex*/TcpInternalStreamServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalStreamServer.@OutputParameterTypeName>(@MethodAsynchronousIdentityCommand, ref _onOutput_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/);
                        }
                    }
                    finally
                    {
                ...
                #region NOT MethodIsReturn
                /*AT:IsInternalClient*/
                void /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterName, /*PUSH:MethodParameter*//*LOOP:InputParameters*/Action<AutoCSer.Net.TcpServer.ReturnValue> _onReturn_)
                {
                    #region IF Attribute.IsExpired
                    if (_onReturn_ == null) throw new Exception(AutoCSer.Net.TcpServer.ReturnType.VersionExpired.ToString());
                ...
                AutoCSer.Net.TcpServer.ReturnValue<@MethodReturnType.FullName> this[/*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/]
                {
                    get
                    {
                        ...
                        try
                        {
                            ...
                            if (_socket_ != null)
                            {
                                ...
                                #endregion IF InputParameterIndex
                                AutoCSer.Net.TcpServer.ReturnValue/*IF:OutputParameterIndex*/<TcpInternalStreamServer.@OutputParameterTypeName>/*IF:OutputParameterIndex*/ _outputParameter_ = _socket_.WaitGet</*IF:InputParameterIndex*/TcpInternalStreamServer.@InputParameterTypeName, /*IF:InputParameterIndex*/TcpInternalStreamServer.@OutputParameterTypeName>(@MethodIdentityCommand, ref _wait_/*IF:InputParameterIndex*/, ref _inputParameter_/*IF:InputParameterIndex*/);
                    ...
                    set
                    {
                        ...
                        #region NOT Attribute.IsExpired
                        #region IF IsClientSendOnly
                        TcpInternalStreamServer.@InputParameterTypeName _sendOnlyInputParameter_ = new TcpInternalStreamServer.@InputParameterTypeName
                        {
                            #region LOOP InputParameters
                            /*PUSH:Parameter*/
                            @ParameterName/*PUSH:Parameter*/ = /*NOTE*/(FullName)(object)/*NOTE*//*PUSH:MethodParameter*/@ParameterName/*PUSH:MethodParameter*/,
                ...
                {
                    _compileSerialize_(new System.Type[] { /*LOOP:SimpleSerializeMethods*/typeof(TcpInternalStreamServer.@InputParameterTypeName), /*LOOP:SimpleSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:SimpleDeSerializeMethods*/typeof(TcpInternalStreamServer.@OutputParameterTypeName), /*LOOP:SimpleDeSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:SerializeMethods*/typeof(TcpInternalStreamServer.@InputParameterTypeName), /*LOOP:SerializeMethods*/null }
                        , new System.Type[] { /*LOOP:DeSerializeMethods*/typeof(TcpInternalStreamServer.@OutputParameterTypeName), /*LOOP:DeSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:JsonSerializeMethods*/typeof(TcpInternalStreamServer.@InputParameterTypeName), /*LOOP:JsonSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:JsonDeSerializeMethods*/typeof(TcpInternalStreamServer.@OutputParameterTypeName), /*LOOP:JsonDeSerializeMethods*/null });
                }
                #endregion IF Attribute.IsCompileSerialize
            }
