    ...
    class TcpOpenSimpleServer : Pub
    {
        ...
        #endregion IF IsSetTcpServer
        {
            ...
            public sealed class TcpOpenSimpleServer/*IF:IsServerCode*/ : AutoCSer.Net.TcpOpenSimpleServer.Server/*IF:IsServerCode*/
            {
                ...
                public TcpOpenSimpleServer(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null/*IF:Type.Type.IsPublic*/, @Type.FullName value = null/*IF:Type.Type.IsPublic*/, AutoCSer.ILog log = null)
                        ...
                        case @MethodIndex:
                            ...
                            try
                            {
                                ...
                                #endregion IF InputParameterIndex
                                {
                                    ...
                                    /*PUSH:Method*/
                                    Value.@MethodName/*PUSH:Method*/(/*IF:ClientParameterName*/socket, /*IF:ClientParameterName*//*LOOP:InputParameters*//*AT:ParameterRef*//*PUSH:Parameter*/inputParameter.@ParameterName, /*PUSH:Parameter*//*LOOP:InputParameters*//*NOTE*/(AutoCSer.Net.TcpServer.ServerCallback<MethodReturnType.FullName>)(object)/*NOTE*/ socket.GetCallback<@OutputParameterTypeName/*NOT:IsVerifyMethod*/, @MethodReturnType.FullName/*NOT:IsVerifyMethod*/>(@MethodIdentityCommand, ref outputParameter));
                                    #endregion IF MethodIsReturn
                                    #region NOT MethodIsReturn
                                    /*PUSH:Method*/
                                    Value.@MethodName/*PUSH:Method*/(/*IF:ClientParameterName*/socket, /*IF:ClientParameterName*//*LOOP:InputParameters*//*AT:ParameterRef*//*PUSH:Parameter*/inputParameter.@ParameterName, /*PUSH:Parameter*//*LOOP:InputParameters*//*NOTE*/(AutoCSer.Net.TcpServer.ServerCallback<MethodReturnType.FullName>)(object)/*NOTE*/socket.GetCallback());
            ...
            public partial class TcpOpenSimpleClient : AutoCSer.Net.TcpOpenSimpleServer.MethodClient<TcpOpenSimpleClient>
            {
                ...
                #endregion IF IsVerifyMethod
                /// <param name="log">日志接口</param>
                public TcpOpenSimpleClient(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute attribute = null/*IF:IsVerifyMethod*/, Func<TcpOpenSimpleClient, bool> verifyMethod = null/*IF:IsVerifyMethod*/, AutoCSer.ILog log = null)
                {
                    if (attribute == null)
                    {
                        #region IF IsServerCode
                        ...
                        attribute = (AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute)AutoCSer.Configuration.Common.Get(typeof(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute), "@ServerRegisterName") ?? _DefaultServerAttribute_;
                ...
                {
                    get { return AutoCSer.JsonDeSerializer.DeSerialize<AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute>(@"@AttributeJson"); }
                }
                #endregion NOT IsServerCode
                ...
                {
                    _compileSerialize_(new System.Type[] { /*LOOP:SimpleSerializeMethods*/typeof(TcpOpenSimpleServer.@InputParameterTypeName), /*LOOP:SimpleSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:SimpleDeSerializeMethods*/typeof(TcpOpenSimpleServer.@OutputParameterTypeName), /*LOOP:SimpleDeSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:SerializeMethods*/typeof(TcpOpenSimpleServer.@InputParameterTypeName), /*LOOP:SerializeMethods*/null }
                        , new System.Type[] { /*LOOP:DeSerializeMethods*/typeof(TcpOpenSimpleServer.@OutputParameterTypeName), /*LOOP:DeSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:JsonSerializeMethods*/typeof(TcpOpenSimpleServer.@InputParameterTypeName), /*LOOP:JsonSerializeMethods*/null }
                        , new System.Type[] { /*LOOP:JsonDeSerializeMethods*/typeof(TcpOpenSimpleServer.@OutputParameterTypeName), /*LOOP:JsonDeSerializeMethods*/null });
                }
                #endregion IF Attribute.IsCompileSerialize
            }
