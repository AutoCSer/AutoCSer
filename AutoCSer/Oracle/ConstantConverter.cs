...
namespace AutoCSer.Sql.Oracle
{
    ...
    internal sealed class ConstantConverter: AutoCSer.Sql.ConstantConverter
    {
        ...
        {
            sqlStream.PrepCharSize(AutoCSer.Date.MillisecondStringSize + 9 + 26);
            sqlStream.Data.Write("to_date('");
            AutoCSer.Date.ToString((DateTime)value, sqlStream);
            sqlStream.Data.Write("','yyyy/mm/dd hh24:mi:ss')");
        }
        /// <summary>
        /// 常量转换字符串
        /// </summary>
