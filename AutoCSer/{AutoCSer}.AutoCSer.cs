...
{
        public partial class ReaderServer
#if !NOJIT
             : AutoCSer.Net.TcpServer.ISetTcpServer<AutoCSer.Net.TcpInternalServer.Server, AutoCSer.Net.TcpInternalServer.ServerAttribute>
#endif
        {
            ...
            private static KeyValue<string, int>[] _identityCommandNames_()
            {
                ...
                names[0].Set(@"(AutoCSer.Net.TcpRegister.ClientId,System.Func<AutoCSer.Net.TcpServer.ReturnValue<AutoCSer.Net.TcpRegister.Log>,bool>)getLog", 0);
                names[1].Set(@"(AutoCSer.Net.TcpInternalServer.ServerSocketSender,ulong,byte[],ref long)verify", 1);
            ...
            public sealed class TcpInternalServer : AutoCSer.Net.TcpInternalServer.Server
            {
                public readonly AutoCSer.Net.TcpRegister.ReaderServer Value;
                /// <summary>
                ...
                /// <param name="log">日志接口</param>
                /// <param name="onCustomData">自定义数据包处理</param>
                public TcpInternalServer(AutoCSer.Net.TcpInternalServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null, AutoCSer.Net.TcpRegister.ReaderServer value = null, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
                    : base(attribute ?? (attribute = AutoCSer.Net.TcpInternalServer.ServerAttribute.GetConfig("TcpRegisterReader", typeof(AutoCSer.Net.TcpRegister.ReaderServer))), verify, onCustomData, log, false)
                {
                    Value = value ?? new AutoCSer.Net.TcpRegister.ReaderServer();
                    setCommandData(3);
                    setCommand(0);
                    setVerifyCommand(1);
                    setCommand(2);
                        ...
                        case 0:
                            ...
                            try
                            {
                                ...
                                if (sender.DeSerialize(ref data, ref inputParameter))
                                {
                                    ...
                                    Value.getLog(inputParameter.p0, sender.GetCallback<_p2, AutoCSer.Net.TcpRegister.Log>(_c0, ref outputParameter));
                                    return;
                                }
                                returnType = AutoCSer.Net.TcpServer.ReturnType.ServerDeSerializeError;
                            }
                ...
                private static readonly AutoCSer.Net.TcpServer.OutputInfo _c2 = new AutoCSer.Net.TcpServer.OutputInfo { OutputParameterIndex = 5, IsBuildOutputThread = true };
                static TcpInternalServer()
                {
                    CompileSerialize(new System.Type[] { null }
            ...
            public partial class TcpInternalClient : AutoCSer.Net.TcpInternalServer.MethodClient<TcpInternalClient>
            {
                ...
                public TcpInternalClient(AutoCSer.Net.TcpInternalServer.ServerAttribute attribute = null, Func<TcpInternalClient, AutoCSer.Net.TcpInternalServer.ClientSocketSender, bool> verifyMethod = null, AutoCSer.Net.TcpServer.ClientLoadRoute<AutoCSer.Net.TcpInternalServer.ClientSocketSender> clientRoute = null, Action<SubArray<byte>> onCustomData = null, AutoCSer.Log.ILog log = null)
                {
                    if (attribute == null)
                    {
                        attribute = AutoCSer.Net.TcpInternalServer.ServerAttribute.GetConfig("TcpRegisterReader", typeof(AutoCSer.Net.TcpRegister.ReaderServer));
                    }
                    _TcpClient_ = new AutoCSer.Net.TcpInternalServer.Client<TcpInternalClient>(this, attribute, onCustomData, log, clientRoute, verifyMethod ?? (Func<TcpInternalClient, AutoCSer.Net.TcpInternalServer.ClientSocketSender, bool>)_timerVerify_);
                    if (attribute.IsAuto) _TcpClient_.TryCreateSocket();
                }
                ...
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _ac0 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 0 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.ClientTaskType.TcpQueue, IsKeepCallback = 1 };
                /// <summary>
                /// TCP 服务端轮询
                /// </summary>
                ...
                {
                    AutoCSer.Net.Callback<AutoCSer.Net.TcpServer.ReturnValue<TcpInternalServer._p2>> _onOutput_ = _TcpClient_.GetCallback<AutoCSer.Net.TcpRegister.Log, TcpInternalServer._p2>(_onReturn_);
                    try
                    {
                        AutoCSer.Net.TcpInternalServer.ClientSocketSender _socket_ = _TcpClient_.Sender;
                        if (_socket_ != null)
                ...
                AutoCSer.Net.TcpServer.ReturnValue<AutoCSer.Net.TcpRegister.ClientId> register()
                {
                    ...
                    try
                    {
                        ...
                        if (_socket_ != null)
                        {
                            ...
                            AutoCSer.Net.TcpServer.ReturnType _returnType_ = _socket_.WaitGet<TcpInternalServer._p5>(_c2, ref _wait_, ref _outputParameter_);
                ...
                static TcpInternalClient()
                {
                    _compileSerialize_(new System.Type[] { null }
                        ...
                        , new System.Type[] { typeof(TcpInternalServer._p1), typeof(TcpInternalServer._p3), null }
...
}namespace AutoCSer.Net.TcpRegister
{
...
#endif
        {
            ...
            private static KeyValue<string, int>[] _identityCommandNames_()
            {
                ...
                names[0].Set(@"(long,AutoCSer.Net.TcpRegister.ServerInfo)checkRegister", 0);
                names[1].Set(@"(AutoCSer.Net.TcpInternalServer.ServerSocketSender,ulong,byte[],ref long)verify", 1);
                names[2].Set(@"(AutoCSer.Net.TcpRegister.ClientId,string)getPort", 2);
                names[3].Set(@"(long,AutoCSer.Net.TcpRegister.ServerInfo)register", 3);
                names[4].Set(@"(long,AutoCSer.Net.TcpRegister.ServerInfo)removeRegister", 4);
                return names;
            }
            /// <summary>
            /// TcpRegister TCP服务
            ...
            public sealed class TcpInternalServer : AutoCSer.Net.TcpInternalServer.Server
            {
                ...
                private static readonly AutoCSer.Net.TcpServer.OutputInfo _c1 = new AutoCSer.Net.TcpServer.OutputInfo { OutputParameterIndex = 4, IsSimpleSerializeOutputParamter = true, IsBuildOutputThread = true };
                private static readonly AutoCSer.Net.TcpServer.OutputInfo _c2 = new AutoCSer.Net.TcpServer.OutputInfo { OutputParameterIndex = 6, IsSimpleSerializeOutputParamter = true, IsBuildOutputThread = true };
                ...
                {
                    CompileSerialize(new System.Type[] { null }
                        , new System.Type[] { typeof(_p2), typeof(_p4), typeof(_p6), null }
            ...
            public partial class TcpInternalClient : AutoCSer.Net.TcpInternalServer.MethodClient<TcpInternalClient>
            {
                ...
                AutoCSer.Net.TcpServer.AwaiterBox<bool> checkRegisterAwaiter(long ticks, AutoCSer.Net.TcpRegister.ServerInfo server)
                {
                    ...
                    if (_socket_ != null)
                    {
                        ...
                        _returnType_ = _socket_.GetAwaiter<TcpInternalServer._p1, AutoCSer.Net.TcpServer.AwaiterReturnValueBox<bool>>(_a0, _awaiter_, ref _inputParameter_, ref _outputParameter_);
                        if (_returnType_ != AutoCSer.Net.TcpServer.ReturnType.Success) _awaiter_.Call(_returnType_);
                    }
                    else _awaiter_.Call(AutoCSer.Net.TcpServer.ReturnType.ClientException);
                    return _awaiter_;
                ...
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _c3 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 3 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous, IsSimpleSerializeOutputParamter = true };
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _a3 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 3 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.ClientTaskType.Timeout, IsSimpleSerializeOutputParamter = true };
                ...
                AutoCSer.Net.TcpServer.ReturnValue<bool> register(long ticks, AutoCSer.Net.TcpRegister.ServerInfo server)
                {
                    ...
                    try
                    {
                        ...
                        if (_socket_ != null)
                        {
                            ...
                            AutoCSer.Net.TcpServer.ReturnType _returnType_ = _socket_.WaitGet<TcpInternalServer._p1, TcpInternalServer._p2>(_c3, ref _wait_, ref _inputParameter_, ref _outputParameter_);
                            return new AutoCSer.Net.TcpServer.ReturnValue<bool> { Type = _returnType_, Value = _outputParameter_.Return };
                        }
                    }
                    finally
                ...
                AutoCSer.Net.TcpServer.AwaiterBox<bool> registerAwaiter(long ticks, AutoCSer.Net.TcpRegister.ServerInfo server)
                {
                    ...
                    if (_socket_ != null)
                    {
                        ...
                        AutoCSer.Net.TcpServer.ReturnType _returnType_;
                        AutoCSer.Net.TcpServer.AwaiterReturnValueBox<bool> _outputParameter_ = default(AutoCSer.Net.TcpServer.AwaiterReturnValueBox<bool>);
                        _returnType_ = _socket_.GetAwaiter<TcpInternalServer._p1, AutoCSer.Net.TcpServer.AwaiterReturnValueBox<bool>>(_a3, _awaiter_, ref _inputParameter_, ref _outputParameter_);
                        if (_returnType_ != AutoCSer.Net.TcpServer.ReturnType.Success) _awaiter_.Call(_returnType_);
                    }
                    else _awaiter_.Call(AutoCSer.Net.TcpServer.ReturnType.ClientException);
                    return _awaiter_;
                ...
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _c4 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 4 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.ClientTaskType.Synchronous };
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _a4 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 4 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.ClientTaskType.Timeout };
                ...
                {
                    _compileSerialize_(new System.Type[] { null }
                        , new System.Type[] { typeof(TcpInternalServer._p2), typeof(TcpInternalServer._p4), typeof(TcpInternalServer._p6), null }
