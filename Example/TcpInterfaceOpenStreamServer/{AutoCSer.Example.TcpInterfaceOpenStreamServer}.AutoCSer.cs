        ...
        internal partial class Expression
        {
            ...
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node
            {
                ...
                public sealed class StaticFieldRemoteExpression : AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1.RemoteExpression
                {
                    ...
                    protected override AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1 getValue()
                    {
    ...
    internal static partial class Expression
    {
        internal partial class Node1
        {
            ...
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1>
            {
                ...
                protected override AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1 getValue()
                {
                    return ((AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1>)base.Parent).GetValue();
                }
                /// <summary>
                /// 远程表达式实例字段测试 远程表达式
                /// </summary>
                public sealed class ValueRemoteExpression : AutoCSer.Net.RemoteExpression.Node<int>
                {
                    ...
                    {
                        AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1 _value_ = ((RemoteExpression)base.Parent).getValue();
                        if (_value_ != null)
                        {
                ...
                public sealed class NextNodeRemoteExpression : AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2.RemoteExpression
                {
                    ...
                    protected override AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2 getValue()
                    {
                        AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node1 _value_ = ((RemoteExpression)base.Parent).getValue();
                        if (_value_ != null)
                        {
    ...
    internal static partial class Expression
    {
        internal partial class Node2
        {
            ...
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2>
            {
                ...
                protected override AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2 getValue()
                {
                    return ((AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2>)base.Parent).GetValue();
                }
                /// <summary>
                /// 远程表达式实例字段测试 远程表达式
                /// </summary>
                public sealed class ValueRemoteExpression : AutoCSer.Net.RemoteExpression.Node<int>
                {
                    ...
                    protected override int getValue()
                    {
                        AutoCSer.Example.TcpInterfaceOpenStreamServer.Expression.Node2 _value_ = ((RemoteExpression)base.Parent).getValue();
                        if (_value_ != null)
                        {
                            return _value_.Value;
                        }
