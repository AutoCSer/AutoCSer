...
namespace AutoCSer.Example.TcpOpenStreamServer
{
    ...
    static partial class Expression
    {
        ...
        {
            using (AutoCSer.Example.TcpOpenStreamServer.RefOut.TcpOpenStreamServer server = new AutoCSer.Example.TcpOpenStreamServer.RefOut.TcpOpenStreamServer())
            {
                if (server.IsListen)
                {
                    using (AutoCSer.Example.TcpOpenStreamServer.TcpStreamClient.RefOut.TcpOpenStreamClient client = new AutoCSer.Example.TcpOpenStreamServer.TcpStreamClient.RefOut.TcpOpenStreamClient())
                    {
