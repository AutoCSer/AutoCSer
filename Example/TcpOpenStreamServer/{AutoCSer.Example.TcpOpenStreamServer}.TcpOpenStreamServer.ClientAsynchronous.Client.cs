        ...
        internal partial class ClientAsynchronous
        {
            ...
            public partial class TcpOpenStreamClient : AutoCSer.Net.TcpOpenStreamServer.MethodClient<TcpOpenStreamClient>
            {
                ...
                public TcpOpenStreamClient(AutoCSer.Net.TcpOpenStreamServer.ServerAttribute attribute = null, AutoCSer.Net.TcpServer.ClientLoadRoute<AutoCSer.Net.TcpOpenStreamServer.ClientSocketSender> clientRoute = null, AutoCSer.Log.ILog log = null)
                {
                    if (attribute == null)
                    {
                        attribute = AutoCSer.Config.Loader.Get<AutoCSer.Net.TcpOpenStreamServer.ServerAttribute>("AutoCSer.Example.TcpOpenStreamServer.ClientAsynchronous") ?? _DefaultServerAttribute_;
                ...
                {
                    AutoCSer.Net.Callback<AutoCSer.Net.TcpServer.ReturnValue<TcpOpenStreamServer._p2>> _onOutput_ = _TcpClient_.GetCallback<int, TcpOpenStreamServer._p2>(_onReturn_);
                    try
                    {
                        AutoCSer.Net.TcpOpenStreamServer.ClientSocketSender _socket_ = _TcpClient_.Sender;
                        if (_socket_ != null)
                        {
                            ...
                            _socket_.Get<TcpOpenStreamServer._p1, TcpOpenStreamServer._p2>(_ac0, ref _onOutput_, ref _inputParameter_);
                        }
                    }
                    finally
                    {
                        if (_onOutput_ != null)
                        {
                            AutoCSer.Net.TcpServer.ReturnValue<TcpOpenStreamServer._p2> _outputParameter_ = new AutoCSer.Net.TcpServer.ReturnValue<TcpOpenStreamServer._p2> { Type = AutoCSer.Net.TcpServer.ReturnType.ClientException };
