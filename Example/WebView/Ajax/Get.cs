    ...
    class Get : AutoCSer.WebView.Ajax<Get>
    {
        ...
        internal static bool TestCase()
        {
            ...
            using (WebClient webClient = new WebClient())
            {
                ...
                string json = webClient.DownloadString(addUrl + "&j=" + System.Web.HttpUtility.UrlEncode(AutoCSer.JsonSerializer.Serialize(new AddParameter { left = 1, right = 2 })));
                ...
                #region Query + XML 支持
                json = webClient.DownloadString(addUrl + "&x=" + System.Web.HttpUtility.UrlEncode(AutoCSer.XmlSerializer.Serialize(new AddParameter { left = 2, right = 3 })));
