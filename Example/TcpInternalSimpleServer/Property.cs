...
namespace AutoCSer.Example.TcpInternalSimpleServer
{
    ...
    /// 可读属性支持 示例
    /// </summary>
    [AutoCSer.Net.TcpInternalSimpleServer.Server(Host = "127.0.0.1", Port = 13103)]
    partial class Property
    {
        ...
        {
            using (AutoCSer.Example.TcpInternalSimpleServer.Property.TcpInternalSimpleServer server = new AutoCSer.Example.TcpInternalSimpleServer.Property.TcpInternalSimpleServer())
            {
                if (server.IsListen)
                {
                    using (AutoCSer.Example.TcpInternalSimpleServer.Property.TcpInternalSimpleClient client = new AutoCSer.Example.TcpInternalSimpleServer.Property.TcpInternalSimpleClient())
                    {
