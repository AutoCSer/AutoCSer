...
namespace AutoCSer.Example.TcpInterfaceStreamServer
{
        internal partial class Expression
        {
            ...
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node
            {
                ...
                /// 远程表达式静态字段测试 远程表达式
                /// </summary>
                public sealed class StaticFieldRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                        private static AutoCSer.Net.RemoteExpression.ReturnValue _createReturnValue_() { return new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1>(); }
                    }
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 getValue()
                    {
                        return AutoCSer.Example.TcpInterfaceStreamServer.Expression/**/.StaticField;
                    }
                    ...
                    {
                        AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 value = getValue();
                        return value != null ? new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1> { Value = value } : null;
                    }
                }
                /// <summary>
                /// 远程表达式静态字段测试 远程表达式
                ...
                /// 远程表达式静态属性测试 远程表达式
                /// </summary>
                public sealed class StaticPropertyRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 getValue()
                    {
                        return AutoCSer.Example.TcpInterfaceStreamServer.Expression/**/.StaticProperty;
                    }
                    protected override object get()
                    {
                ...
                /// 远程表达式静态方法测试 远程表达式
                /// </summary>
                public sealed class StaticMethodRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 getValue()
                    {
                        return AutoCSer.Example.TcpInterfaceStreamServer.Expression/**/.StaticMethod(value);
                    }
                    protected override object get()
                    {
...
}namespace AutoCSer.Example.TcpInterfaceStreamServer
{
    internal static partial class Expression
    {
        internal partial class Node1
        {
            ...
            /// 远程表达式测试 远程表达式
            /// </summary>
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1>
            {
                ...
                private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 _getValue_()
                {
                    object _value_ = base.getParentValue();
                    return _value_ != null ? (AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1)_value_ : default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1);
                }
                protected override object get()
                {
                    return _getValue_();
                ...
                protected override AutoCSer.Net.RemoteExpression.ReturnValue getReturn()
                {
                    AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 value = _getValue_();
                    return value != null ? new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1> { Value = value } : null;
                }
                /// <summary>
                /// 远程表达式实例字段测试 远程表达式
                ...
                public sealed class ValueRemoteExpression : AutoCSer.Net.RemoteExpression.Node<int>
                {
                    ...
                    private int getValue()
                    {
                        ...
                        if (_value_ != null)
                        {
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1)_value_).Value;
                        }
                        return default(int);
                    }
                    protected override object get()
                ...
                /// 远程表达式实例属性测试 远程表达式
                /// </summary>
                public sealed class NextNodeRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                        private static AutoCSer.Net.RemoteExpression.ReturnValue _createReturnValue_() { return new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2>(); }
                    }
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2 getValue()
                    {
                        object _value_ = getParentValue();
                        if (_value_ != null)
                        {
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1)_value_).NextNode;
                        }
                        return default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2);
                    }
                    protected override object get()
                    {
                    ...
                    protected override AutoCSer.Net.RemoteExpression.ReturnValue getReturn()
                    {
                        AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2 value = getValue();
                        return value != null ? new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2> { Value = value } : null;
                    }
                }
                /// <summary>
                /// 远程表达式实例属性测试 远程表达式
                ...
                /// 远程表达式实例方法测试 远程表达式
                /// </summary>
                public sealed class GetNextNodeRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2 getValue()
                    {
                        ...
                        if (_value_ != null)
                        {
                            ...
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1)_value_).GetNextNode(value);
                        }
                        return default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2);
                    }
                    protected override object get()
...
}namespace AutoCSer.Example.TcpInterfaceStreamServer
{
    internal static partial class Expression
    {
        internal partial class Node2
        {
            ...
            /// 远程表达式测试 远程表达式
            /// </summary>
            public class RemoteExpression : AutoCSer.Net.RemoteExpression.Node<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2>
            {
                internal RemoteExpression() : base(_clientNodeId_.Id) { }
                protected RemoteExpression(int clientNodeId) : base(clientNodeId) { }
                private static class _clientNodeId_
                ...
                private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2 _getValue_()
                {
                    object _value_ = base.getParentValue();
                    return _value_ != null ? (AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2)_value_ : default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2);
                }
                protected override object get()
                {
                    return _getValue_();
                ...
                protected override AutoCSer.Net.RemoteExpression.ReturnValue getReturn()
                {
                    AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2 value = _getValue_();
                    return value != null ? new AutoCSer.Net.RemoteExpression.ReturnValue<AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2> { Value = value } : null;
                }
                /// <summary>
                /// 远程表达式实例字段测试 远程表达式
                ...
                public sealed class ValueRemoteExpression : AutoCSer.Net.RemoteExpression.Node<int>
                {
                    ...
                    private int getValue()
                    {
                        ...
                        if (_value_ != null)
                        {
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2)_value_).Value;
                        }
                        return default(int);
                    }
                    protected override object get()
                ...
                /// 远程表达式实例属性测试 远程表达式
                /// </summary>
                public sealed class LastNodeRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 getValue()
                    {
                        ...
                        if (_value_ != null)
                        {
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2)_value_).LastNode;
                        }
                        return default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1);
                    }
                    protected override object get()
                    {
                ...
                /// 远程表达式实例方法测试 远程表达式
                /// </summary>
                public sealed class GetLastNodeRemoteExpression : AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1.RemoteExpression
                {
                    private static class _clientNodeId_
                    {
                        internal static readonly int Id = registerClient(_createReturnValue_);
                    ...
                    private AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1 getValue()
                    {
                        ...
                        if (_value_ != null)
                        {
                            ...
                            return ((AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node2)_value_).GetLastNode(value);
                        }
                        return default(AutoCSer.Example.TcpInterfaceStreamServer.Expression.Node1);
                    }
                    protected override object get()
