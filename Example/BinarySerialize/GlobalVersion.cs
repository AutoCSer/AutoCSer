...
namespace AutoCSer.Example.BinarySerialize
{
    ...
    class GlobalVersion
    {
        ...
        internal static bool TestCase()
        {
            ...
            byte[] data0 = AutoCSer.BinarySerializer.Serialize(new GlobalVersion { Value9 = 1 }, new AutoCSer.BinarySerialize.SerializeConfig { GlobalVersion = 0 });
            Version1 value1 = AutoCSer.BinaryDeSerializer.DeSerialize<Version1>(data0);
            if (value1 == null || value1.Value9 != 1)
            {
                return false;
            }
            Version2 value2 = AutoCSer.BinaryDeSerializer.DeSerialize<Version2>(data0);
            if (value2 == null || value2.Value9 != 1)
            {
                return false;
            }
            Version3 value3 = AutoCSer.BinaryDeSerializer.DeSerialize<Version3>(data0);
            ...
            byte[] data1 = AutoCSer.BinarySerializer.Serialize(new Version1 { Value9 = 1, Value8 = 2 }, new AutoCSer.BinarySerialize.SerializeConfig { GlobalVersion = 1 });
            ...
            byte[] data2 = AutoCSer.BinarySerializer.Serialize(new Version2 { Value9 = 1, Value8 = 2, Value7 = 3 }, new AutoCSer.BinarySerialize.SerializeConfig { GlobalVersion = 2 });
            ...
            byte[] data3 = AutoCSer.BinarySerializer.Serialize(new Version3 { Value9 = 1, Value8 = 2, Value6 = 4 }, new AutoCSer.BinarySerialize.SerializeConfig { GlobalVersion = 3 });
