...
namespace AutoCSer.Example.TcpOpenServer.TcpClient
{
        ...
        {
            /// <summary>
            /// AutoCSer.Example.TcpOpenServer.ClientAsynchronous TCP服务参数
            /// </summary>
            ...
            public class TcpOpenClient : AutoCSer.Net.TcpOpenServer.MethodClient<TcpOpenClient>
            {
                ...
                private static readonly AutoCSer.Net.TcpServer.CommandInfo _ac0 = new AutoCSer.Net.TcpServer.CommandInfo { Command = 0 + 128, InputParameterIndex = 1, TaskType = AutoCSer.Net.TcpServer.MethodAttribute.DefaultClientTask , CommandFlags = AutoCSer.Net.TcpServer.CommandFlags.JsonSerialize };
                    ...
                    if (_onReturn_ == null || _onOutput_ != null)
                    {
                        ...
                        try
                        {
                            ...
                            if (_socket_ != null)
                            {
                                ...
                                _socket_.Get<TcpOpenServer._p1, TcpOpenServer._p2>(_ac0, _onOutput_, ref _inputParameter_);
                                _isWait_ = 1;
                            }
                        }
                        finally
