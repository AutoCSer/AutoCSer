...
namespace AutoCSer.Example.TcpInterfaceSimpleServer
{
    ...
    static partial class Expression
    {
        ...
        {
            using (AutoCSer.Net.TcpInternalSimpleServer.Server server = AutoCSer.Net.TcpInternalSimpleServer.Emit.Server<IRefOut>.Create(new RefOut()))
            {
                if (server.IsListen)
                {
                    using (AutoCSer.Net.TcpInternalSimpleServer.Emit.MethodClient client = AutoCSer.Net.TcpInternalSimpleServer.Emit.Client<IRefOut>.Create() as AutoCSer.Net.TcpInternalSimpleServer.Emit.MethodClient)
                    {
