...
namespace AutoCSer.Example.TcpStaticServer
{
    ...
    partial class RefOut
    {
        ...
        /// <param name="product">乘积</param>
        /// <returns>和</returns>
        [AutoCSer.Net.TcpStaticServer.Method(ServerName = ServerName.Example2)]
        ...
        {
            int right = 3, product;
            AutoCSer.Net.TcpServer.ReturnValue<int> sum = AutoCSer.Example.TcpStaticServer.TcpCall.RefOut.Add1(2, ref right, out product);
            ...
            right = 3;
            product = 0;
            sum = AutoCSer.Example.TcpStaticServer.TcpCall.RefOut.Add2(2, ref right, out product);
