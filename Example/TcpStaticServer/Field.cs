...
namespace AutoCSer.Example.TcpStaticServer
{
    ...
    partial class Field
    {
        ...
        {
            GetField = 2;
            AutoCSer.Net.TcpServer.ReturnValue<int> value = AutoCSer.Example.TcpStaticServer.TcpCall.Field.GetField;
            ...
            SetField = 0;
            AutoCSer.Example.TcpStaticServer.TcpCall.Field.SetField = 3;
            if (SetField != 3)
            {
                return false;
            }
