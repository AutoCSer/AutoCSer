...
namespace AutoCSer.Example.TcpOpenSimpleServer.TcpSimpleClient
{
        ...
        {
            /// <summary>
            /// AutoCSer.Example.TcpOpenSimpleServer.Static TCP服务参数
            /// </summary>
            ...
            public partial class TcpOpenSimpleClient : AutoCSer.Net.TcpOpenSimpleServer.MethodClient<TcpOpenSimpleClient>
            {
                ...
                public TcpOpenSimpleClient(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute attribute = null, AutoCSer.ILog log = null)
                {
                    if (attribute == null)
                    {
                        attribute = (AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute)AutoCSer.Configuration.Common.Get(typeof(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute), "AutoCSer.Example.TcpOpenSimpleServer.Static") ?? _DefaultServerAttribute_;
