...
namespace AutoCSer.Example.TcpOpenSimpleServer.TcpSimpleClient
{
        ...
        {
            /// <summary>
            /// AutoCSer.Example.TcpOpenSimpleServer.Field TCP服务参数
            /// </summary>
            ...
            public partial class TcpOpenSimpleClient : AutoCSer.Net.TcpOpenSimpleServer.MethodClient<TcpOpenSimpleClient>
            {
                ...
                public TcpOpenSimpleClient(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute attribute = null, AutoCSer.ILog log = null)
                {
                    if (attribute == null)
                    {
                        attribute = (AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute)AutoCSer.Configuration.Common.Get(typeof(AutoCSer.Net.TcpOpenSimpleServer.ServerAttribute), "AutoCSer.Example.TcpOpenSimpleServer.Field") ?? _DefaultServerAttribute_;
                        if (attribute.Name == null) attribute.Name = "AutoCSer.Example.TcpOpenSimpleServer.Field";
                    }
                ...
                public AutoCSer.Net.TcpServer.ReturnValue<int> SetField
                {
                    get
                    {
                        ...
                        {
                            TcpOpenSimpleServer._p1 _outputParameter_ = default(TcpOpenSimpleServer._p1);
                            AutoCSer.Net.TcpServer.ReturnType _returnType_ = _TcpClient_.Get<TcpOpenSimpleServer._p1>(_c1, ref _outputParameter_);
                            return new AutoCSer.Net.TcpServer.ReturnValue<int> { Type = _returnType_, Value = _outputParameter_.Return };
                        }
                        return new AutoCSer.Net.TcpServer.ReturnValue<int> { Type = AutoCSer.Net.TcpServer.ReturnType.ClientException };
                    }
